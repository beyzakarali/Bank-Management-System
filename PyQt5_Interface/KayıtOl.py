...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 501, 400))
        ...
        self.pushButton.setGeometry(QtCore.QRect(240, 250, 51, 31))
        ...
        self.tab_2.setMinimumSize(QtCore.QSize(500, 400))
        self.tab_2.setStyleSheet("background-color: rgb(255, 170, 255);\n"
     "border-top-color: rgb(85, 170, 255);")
        self.tab_2.setObjectName("tab_2")
        self.comboBox = QtWidgets.QComboBox(self.tab_2)
        self.comboBox.setGeometry(QtCore.QRect(240, 40, 131, 22))
        ...
        self.label_10.setGeometry(QtCore.QRect(50, 40, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.listView = QtWidgets.QListView(self.tab_2)
        self.listView.setGeometry(QtCore.QRect(90, 100, 231, 131))
        self.listView.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.listView.setObjectName("listView")
        self.pushButton_4 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_4.setGeometry(QtCore.QRect(170, 260, 75, 31))
        self.pushButton_4.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_4.setObjectName("pushButton_4")
        self.commandLinkButton_3 = QtWidgets.QCommandLinkButton(self.tab_2)
        self.commandLinkButton_3.setGeometry(QtCore.QRect(360, 320, 131, 41))
       ...
       # self.pushButton.clicked.connect(self.lineEdit.text()) ########################################################
        ...
        MainWindow.setTabOrder(self.commandLinkButton_2, self.comboBox)
        MainWindow.setTabOrder(self.comboBox, self.listView)
        MainWindow.setTabOrder(self.listView, self.pushButton_4)
        MainWindow.setTabOrder(self.pushButton_4, self.commandLinkButton_3)
        MainWindow.setTabOrder(self.commandLinkButton_3, self.tabWidget)
    def bilgial(self):
        print ("yazdıgın sey :" + self.lineEdit.text())
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "HEPSİ"))
        self.comboBox.setItemText(1, _translate("MainWindow", "A Bankası"))
        self.comboBox.setItemText(2, _translate("MainWindow", "B Bankası"))
        self.comboBox.setItemText(3, _translate("MainWindow", "C Bankası"))
        self.comboBox.setItemText(4, _translate("MainWindow", "D Bankası"))
        self.label_10.setText(_translate("MainWindow", "Bankalarınızı Seçiniz"))
        self.pushButton_4.setText(_translate("MainWindow", "ONAYLA"))
        self.commandLinkButton_3.setText(_translate("MainWindow", "ANA SAYFA"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "BANKALAR"))
