...
def FaceDatasetsReading():
    ...
    for i in range(len(knownPersonsPhotos)):
        ...
        known_face_encodings.append(personEncoding)
        known_face_names.append(
            knownPersonsPhotos[i][0:len(knownPersonsPhotos[i])-4])
    print("knownPersonsEncoding : ") 
...
while True:
    ...
    # Hit 's' on the keyboard to take a photo!
